"""Action handler seed for regulatory_filing:mark_late."""
...
ACTION_ID = "mark_late"
ACTION_RULE = {'allowed_in_states': ['draft', 'submitted', 'confirmed'], 'transitions_to': None}
...
def handle_mark_late(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
