"""Relation service seed for regulatory_filing."""
...
RELATED_DOCS = [{'doc_id': 'regulatory_obligation', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'submission_confirmation', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'compliance_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'authority'}, {'description': 'due rules from regulatory_obligation'}]
