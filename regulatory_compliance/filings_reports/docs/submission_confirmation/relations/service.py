"""Relation service seed for submission_confirmation."""
...
BORROWED_FIELDS = [{'description': 'filing type'}, {'description': 'authority'}, {'description': 'submission date from regulatory_filing'}]
