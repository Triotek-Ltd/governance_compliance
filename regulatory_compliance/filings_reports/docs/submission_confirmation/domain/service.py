"""Business-domain service seed for Submission Confirmation."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'received_date': 'schedule_marker'}, 'search_fields': ['title', 'reference_no', 'description', 'confirmation_number', 'filing', 'external_acknowledgement_reference'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'active', 'lifecycle_states': ['active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'record': None, 'view': None, 'archive': 'archived'}}

WORKFLOW_HINTS = {'relation_context': {'related_docs': ['regulatory_filing'], 'borrowed_fields': ['filing type', 'authority', 'submission date from regulatory_filing'], 'inferred_roles': ['compliance officer']}, 'actors': ['compliance officer'], 'action_actors': {'record': ['compliance officer'], 'archive': ['compliance officer']}}

SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['regulatory_filing'], 'action_targets': {'record': None, 'view': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
