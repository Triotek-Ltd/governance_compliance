...
RELATED_DOCS = [{'doc_id': 'regulatory_obligation', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'submission_confirmation', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'authority and due rule from regulatory_obligation'}]
