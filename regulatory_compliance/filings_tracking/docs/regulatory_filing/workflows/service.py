...
ACTION_RULES = {'confirm': {'allowed_in_states': ['draft', 'submitted', 'confirmed'], 'transitions_to': 'confirmed'}, 'submit': {'allowed_in_states': ['draft', 'submitted', 'confirmed'], 'transitions_to': 'submitted'}, 'create': {'allowed_in_states': ['draft', 'submitted', 'confirmed'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['draft', 'submitted', 'confirmed'], 'transitions_to': 'archived'}}
