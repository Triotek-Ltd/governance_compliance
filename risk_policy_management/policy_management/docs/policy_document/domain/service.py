...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'owner': 'actor_reference', 'approval_date': 'schedule_marker', 'publication_date': 'schedule_marker', 'next_review_date': 'schedule_marker', 'related_risk_register_entry': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'policy_number', 'owner', 'version'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'approved', 'published', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'submit': 'approved', 'approve': 'approved', 'publish': 'published', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['supports legal compliance and obligation management'], 'related_docs': ['risk_register_entry'], 'action_targets': {'create': None, 'submit': 'approved', 'approve': 'approved', 'publish': 'published', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
