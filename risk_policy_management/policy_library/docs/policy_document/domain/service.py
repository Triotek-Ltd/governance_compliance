"""Business-domain service seed for Policy Document."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'transaction_flow', 'supports_submission': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['draft', 'approved', 'published', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'party_reference', 'currency': 'currency_code', 'total_amount': 'total_amount', 'owner': 'actor_reference', 'approval_date': 'schedule_marker', 'publication_date': 'schedule_marker', 'next_review_date': 'schedule_marker'}, 'search_fields': ['title', 'reference_no', 'description', 'policy_no', 'owner', 'version'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'approved', 'published', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'archive': 'archived', 'submit': 'approved', 'create': None, 'approve': 'approved', 'publish': 'published'}}

WORKFLOW_HINTS = {'business_objective': 'Track policy approval, publication, and review against governance or risk needs.', 'actors': ['policy owner', 'approver', 'compliance officer'], 'primary_transitions': ['policy_document: draft -> approved -> published -> archived']}
