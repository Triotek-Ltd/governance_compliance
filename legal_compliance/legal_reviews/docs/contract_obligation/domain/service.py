"""Business-domain service seed for Contract Obligation."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['open', 'in_progress', 'fulfilled', 'closed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'owner': 'actor_reference', 'due_date': 'schedule_marker', 'fulfilment_status': 'status_flag'}, 'search_fields': ['title', 'reference_no', 'description', 'obligation_no', 'agreement', 'obligation_text'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'in_progress', 'fulfilled', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'close': 'closed', 'create': None, 'assign': 'in_progress', 'archive': 'archived', 'track': None}}

WORKFLOW_HINTS = {'business_objective': 'Track contractual duties and deadlines until fulfilment or closure.', 'actors': ['legal officer', 'owner', 'business owner'], 'primary_transitions': ['contract_obligation: open -> in_progress -> fulfilled -> closed -> archived']}
