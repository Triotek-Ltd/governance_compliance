"""Workflow service seed for legal_review_case."""
...
ACTION_RULES = {'close': {'allowed_in_states': ['open', 'in_review'], 'transitions_to': 'closed'}, 'create': {'allowed_in_states': ['open', 'in_review'], 'transitions_to': None}, 'assign': {'allowed_in_states': ['open', 'in_review'], 'transitions_to': 'in_review'}, 'review': {'allowed_in_states': ['open', 'in_review'], 'transitions_to': 'in_review'}}
