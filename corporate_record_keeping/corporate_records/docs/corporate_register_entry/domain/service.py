"""Business-domain service seed for Corporate Register Entry."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'appointment_or_resolution_date': 'schedule_marker'}, 'search_fields': ['title', 'reference_no', 'description', 'entry_no', 'register_type', 'subject_entity_or_person'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'active', 'lifecycle_states': ['active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'record': None, 'archive': 'archived', 'review': None}}

WORKFLOW_HINTS = {'business_objective': 'Track the official register trail for corporate appointments, resolutions, and similar records.', 'actors': ['corporate secretary', 'compliance officer'], 'primary_transitions': ['corporate_register_entry: active -> archived']}

class DomainService:
    doc_id = "corporate_register_entry"
    archetype = "ledger"
    doc_kind = "ledger"
