"""Workflow service seed for corporate_document."""
...
ACTION_RULES = {'create': {'allowed_in_states': ['draft', 'active'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['draft', 'active'], 'transitions_to': 'archived'}, 'review': {'allowed_in_states': ['draft', 'active'], 'transitions_to': None}}
