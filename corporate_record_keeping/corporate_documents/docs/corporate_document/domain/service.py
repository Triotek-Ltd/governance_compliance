"""Business-domain service seed for Corporate Document."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'effective_date': 'schedule_marker', 'related_corporate_register_entry': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'document_number', 'document_type', 'governing_body'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'review': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['supports legal, audit, and regulatory controls'], 'related_docs': ['corporate_register_entry'], 'action_targets': {'create': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
