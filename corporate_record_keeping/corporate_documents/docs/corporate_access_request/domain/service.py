"""Business-domain service seed for Corporate Access Request."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'requester': 'actor_reference', 'approver': 'actor_reference', 'decision_date': 'schedule_marker', 'related_corporate_document': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'request_number', 'requester', 'target_record'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'approved', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'approve': 'approved', 'close': 'closed', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['supports legal, audit, and regulatory controls'], 'related_docs': ['corporate_document'], 'action_targets': {'create': None, 'approve': 'approved', 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
