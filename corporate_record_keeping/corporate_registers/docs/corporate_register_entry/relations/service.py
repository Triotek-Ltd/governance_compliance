"""Relation service seed for corporate_register_entry."""
...
RELATED_DOCS = [{'doc_id': 'corporate_document', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'document title'}, {'description': 'authority context from corporate_document'}]
