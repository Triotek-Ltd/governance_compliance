...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'requester': 'actor_reference', 'approver': 'actor_reference', 'decision_date': 'schedule_marker'}, 'search_fields': ['title', 'reference_no', 'description', 'request_no', 'requester', 'target_record'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'approved', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'close': 'closed', 'create': None, 'approve': 'approved', 'archive': 'archived'}}

WORKFLOW_HINTS = {'business_objective': 'Control and audit access to corporate governance records.', 'actors': ['requester', 'approver', 'corporate secretary'], 'primary_transitions': ['corporate_access_request: open -> approved -> closed -> archived']}
