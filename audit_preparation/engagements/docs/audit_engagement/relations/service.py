...
RELATED_DOCS = [{'doc_id': 'audit_document_request', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'audit_finding', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'audit_response_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
