...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'request_date': 'schedule_marker', 'related_audit_document_request': 'relation_collection', 'related_audit_finding': 'relation_collection', 'related_audit_response_record': 'relation_collection', 'related_corrective_action_plan': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'engagement_number', 'requester_name', 'requester_email'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'in_progress', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': 'in_progress', 'review': None, 'close': 'closed', 'archive': 'archived', 'accept': None, 'refer': None, 'request_clarification': None, 'escalate': None}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['supports governance assurance and remediation tracking', 'consulting explanations', 'implementation planning', 'user guides', 'demo narratives'], 'related_docs': ['audit_document_request', 'audit_finding', 'audit_response_record', 'corrective_action_plan'], 'action_targets': {'create': None, 'assign': 'in_progress', 'review': None, 'close': 'closed', 'archive': 'archived', 'accept': None, 'refer': None, 'request_clarification': None, 'escalate': None}, 'action_side_effects_file': 'side_effects.json'}
