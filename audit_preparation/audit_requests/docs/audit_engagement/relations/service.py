"""Relation service seed for audit_engagement."""
...
RELATED_DOCS = [{'doc_id': 'audit_document_request', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'audit_finding', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'audit_response_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'corrective_action_plan', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'requester'}, {'description': 'business-unit context from linked party or department records'}]
