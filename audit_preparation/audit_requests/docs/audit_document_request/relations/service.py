"""Relation service seed for audit_document_request."""
...
RELATED_DOCS = [{'doc_id': 'audit_engagement', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'engagement title'}, {'description': 'business area'}, {'description': 'requester from audit_engagement'}]
