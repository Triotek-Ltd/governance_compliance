"""Business-domain service seed for Audit Document Request."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['open', 'requested', 'provided', 'closed'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'requested_from': 'actor_reference', 'due_date': 'schedule_marker', 'provided_date': 'schedule_marker'}, 'search_fields': ['title', 'reference_no', 'description', 'request_number', 'engagement', 'requested_item'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'requested', 'provided', 'closed'], 'terminal_states': ['closed'], 'action_targets': {'create': None, 'assign': 'requested', 'confirm': 'closed', 'close': 'closed'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['audit_engagement'], 'action_targets': {'create': None, 'assign': 'requested', 'confirm': 'closed', 'close': 'closed'}, 'action_side_effects_file': 'side_effects.json'}
