"""Business-domain service seed for Audit Finding."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['open', 'confirmed', 'resolved', 'closed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'due_date': 'schedule_marker', 'related_corrective_action_plan': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'finding_number', 'engagement', 'category'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'confirmed', 'resolved', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'review': None, 'confirm': 'confirmed', 'close': 'closed', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['supports governance assurance and remediation tracking', 'consulting explanations', 'implementation planning', 'user guides', 'demo narratives'], 'related_docs': ['corrective_action_plan'], 'action_targets': {'create': None, 'review': None, 'confirm': 'confirmed', 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
