...
RELATED_DOCS = [{'doc_id': 'corrective_action_plan', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'engagement'}, {'description': 'business-area context from audit_engagement'}]
