"""Relation service seed for corrective_action_plan."""
...
RELATED_DOCS = [{'doc_id': 'audit_finding', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'severity'}, {'description': 'recommendation from audit_finding'}]
