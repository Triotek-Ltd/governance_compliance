"""Business-domain service seed for Corrective Action Plan."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'owner': 'actor_reference', 'target_date': 'schedule_marker'}, 'search_fields': ['title', 'reference_no', 'description', 'plan_number', 'finding', 'owner'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'in_progress', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': 'in_progress', 'track': None, 'close': 'closed'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['audit_finding'], 'action_targets': {'create': None, 'assign': 'in_progress', 'track': None, 'close': 'closed'}, 'action_side_effects_file': 'side_effects.json'}
