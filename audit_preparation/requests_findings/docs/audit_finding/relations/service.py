"""Relation service seed for audit_finding."""
...
RELATED_DOCS = [{'doc_id': 'audit_engagement', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'corrective_action_plan', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'engagement context from audit_engagement'}]
