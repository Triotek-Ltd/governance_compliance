...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'requested_from': 'actor_reference', 'due_date': 'schedule_marker', 'provided_date': 'schedule_marker'}, 'search_fields': ['title', 'reference_no', 'description', 'request_no', 'engagement', 'requested_item'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'requested', 'provided', 'closed'], 'terminal_states': ['closed'], 'action_targets': {'confirm': 'closed', 'create': None, 'assign': 'requested', 'close': 'closed'}}
