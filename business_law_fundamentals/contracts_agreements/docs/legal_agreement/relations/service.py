"""Relation service seed for legal_agreement."""
...
RELATED_DOCS = [{'doc_id': 'legal_review_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'contract_obligation', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'agreement-type defaults'}, {'description': 'signer details from linked configuration records'}]
