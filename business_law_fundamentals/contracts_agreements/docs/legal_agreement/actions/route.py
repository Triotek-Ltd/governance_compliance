"""Action handler seed for legal_agreement:route."""
...
ACTION_ID = "route"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'approved', 'executed', 'expired', 'renewed'], 'transitions_to': None}
...
def handle_route(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
