"""Action handler seed for legal_agreement:renew."""
...
ACTION_ID = "renew"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'approved', 'executed', 'expired', 'renewed'], 'transitions_to': 'renewed'}
