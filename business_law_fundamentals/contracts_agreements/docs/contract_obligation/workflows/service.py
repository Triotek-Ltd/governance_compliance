...
ACTION_RULES = {'create': {'allowed_in_states': ['open', 'in_progress', 'fulfilled'], 'transitions_to': None}, 'assign': {'allowed_in_states': ['open', 'in_progress', 'fulfilled'], 'transitions_to': 'in_progress'}, 'track': {'allowed_in_states': ['open', 'in_progress', 'fulfilled'], 'transitions_to': None}, 'close': {'allowed_in_states': ['open', 'in_progress', 'fulfilled'], 'transitions_to': 'closed'}, 'archive': {'allowed_in_states': ['open', 'in_progress', 'fulfilled'], 'transitions_to': 'archived'}}
