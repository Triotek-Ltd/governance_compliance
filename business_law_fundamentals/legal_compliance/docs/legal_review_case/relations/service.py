"""Relation service seed for legal_review_case."""
...
RELATED_DOCS = [{'doc_id': 'legal_agreement', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'agreement type'}, {'description': 'counterparty'}, {'description': 'routing status from legal_agreement'}]
