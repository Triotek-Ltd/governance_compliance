"""Business-domain service seed for Legal Review Case."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'reviewer': 'actor_reference', 'review_date': 'schedule_marker'}, 'search_fields': ['title', 'reference_no', 'description', 'review_number', 'agreement', 'reviewer'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'in_review', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': 'in_review', 'review': 'in_review', 'close': 'closed'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['legal_agreement'], 'action_targets': {'create': None, 'assign': 'in_review', 'review': 'in_review', 'close': 'closed'}, 'action_side_effects_file': 'side_effects.json'}
